...
| **R-02** | Database connectivity failure (Bahrain Region Outage) | Low | Critical | Mitigation | **Issue** | **Materialized:** Migrated database cluster from Bahrain (me-south-1) to Frankfurt (eu-central-1). |
...
| **R-05** | Missing MVP deadline due to infrastructure crisis | Medium | High | Acceptance | **Closed** | **Scope Reduction:** Deferred 15 points of non-essential API routes to prioritize "The Golden Path". |
